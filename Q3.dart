...
class _UserListScreenState extends State<UserListScreen> {
  ...
  // Fix: Make selectedUser nullable (String?) and handle null case in the UI with a fallback value.
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Padding(
            padding: const EdgeInsets.all(16.0),
            child: Text(
              // Use null-aware operator and fallback to handle null selectedUser
          ...
          // Fix: Wrap ListView.builder in Expanded to constrain its height to available space.
          ...
          // Fix: Add conditional check to display 'No users found' when filteredUsers is empty.
              ...
              : Expanded(
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      // Fix: Add ValueKey based on user name to ensure proper widget diffing.
                      return ListTile(
                        ...
                        trailing: IconButton(
                          ...
                          onPressed: () {
                            ...
                            // Fix: Check if deleted user is selected and clear selectedUser if needed.
                            setState(() {
      ...
      // Fix: Move FloatingActionButton to Scaffold's floatingActionButton property.
  ...
  // Fix: Use separate allUsers and filteredUsers lists to preserve original data.
  ...
  // Fix: Consolidate state updates in a single setState call.
  void addUser() {
    setState(() {
